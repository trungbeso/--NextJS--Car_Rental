                            ...
                            >
                                <Dialog.Panel
                                    ...
                                    <div className='flex-1 flex flex-col gap-3'>
                                        <div className="reletive w-full h-40 bg-pattern bg-cover bg-center rounded-lg">
                                            <Image src={generateCarImageUrl(car)} alt='car model' priority
                                                   width={250} height={120} className='justify-center items-center align-middle mx-auto'/>
                                        </div>
